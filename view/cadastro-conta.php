...
<body>
    ...
    <main role="main">
        <div class="jumbotron">
            <div class="container">
                <form method="post" action="../database/db-inserir-conta.php">
                    <div class="form-group">
                        <div class="form-row">
                            <div class="col">
                                <label for="saldo">Saldo</label>
                                <input id="saldo" class="form-control" placeholder="Ex. 1200,00" autocomplete="off">
                            </div>
                            <div class="col">
                                <label for="limite">Limite</label>
                                <input id="limite" class="form-control" placeholder="Ex. 2000,00" autocomplete="off">
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                            ...
                            <div class="col">
                                ...
                                <select class="form-control" name="pessoa" id="pessoa">
                                    ...
                                    foreach ($pessoa as $key => $value) {
                                        ?>
                                        <option value="<?php echo $value['nro_pessoa']; ?>">
                                            <?php echo $value['nome']; ?>
                                        </option>
                                    <?php
                                    }
                                ...
                                <small>Clique para selecionar o cliente.</small>
                            </div>
                            <div class="col">
                                <label for="agencia">Agência</label>
                                <input id="agencia" class="form-control" placeholder="Ex. 1" autocomplete="off">
